              ...
              <div className="unified-tech-item">
                ...
                <div className="unified-tech-item-content">
                  ...
                  <p className="unified-tech-item-desc">
                    Система автоматизирует весь процесс от библиотеки до гибридизационного захвата. Пользователю достаточно загрузить образец в картриджи с премиксованными реагентами. Весь процесс проходит внутри закрытой системы, что сводит к минимуму риск контаминации и ошибки оператора.
                  </p>
                </div>
              </div>
            ...
            <div className="unified-tech-list" style={{ marginTop: '24px' }}>
              ...
              <div className="unified-tech-item">
                ...
                <div className="unified-tech-item-content">
                  <h4 className="unified-tech-item-title">«Образец на входе — библиотека на выходе»</h4>
                  <p className="unified-tech-item-desc">
                    Полная автоматизация всего конвейера NGS — от экстракции образца до подготовки библиотек, гибридизационного захвата и контроля качества без участия человека.
                  </p>
                </div>
              </div>
        ...
        <div className="unified-tech-card" style={{ 
          ...
          <div style={{ 
            ...
            <p style={{ 
              ...
              Готовые пайплайны и интеграция с биоинформатическими базами. Установка програмного обеспечения на ваши компьютеры или сервера, или поставка в виде готовой биоинформатической станции.
            </p>
          </div>
        </div>
      </div>
