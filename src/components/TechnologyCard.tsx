      ...
      <div className="unified-tech-list">
        ...
        <div className="unified-tech-item">
          ...
          <div className="unified-tech-item-content">
            ...
            <p className="unified-tech-item-desc">
              Технология создана разработчиком базовых принципов SBS, что гарантирует высочайшее качество данных (Q30 ≥ 90%) и полную научную преемственность методик с мировыми стандартами.
            </p>
          </div>
        </div>
        ...
        <div className="unified-tech-item">
          ...
          <div className="unified-tech-item-content">
            ...
            <p className="unified-tech-item-desc">
              Считывание всех четырех оснований с помощью всего одного флуорофора позволило отказаться от многоканальной оптической схемы, громоздких каскадов дихроичных зеркал и нескольких лазеров, сделав оптический блок прибора линейным и компактным. Радикальное упрощение оптико-механической системы повысило устойчивость к внешним вибрациям, сделало приборы по-настоящему отказоустойчивыми, снизило себестоимость и свело к минимуму риск поломок даже при интенсивной исследовательской нагрузке.
            </p>
          </div>
        </div>
        ...
        <div className="unified-tech-item">
          ...
          <div className="unified-tech-item-content">
            ...
            <p className="unified-tech-item-desc">
              Полный цикл тестирования занимает от 7 до 24 часов, что критически важно для оперативного исследования инфекций, онкопанелей и проведения комплексных генетических исследований.
            </p>
          </div>
        </div>
