      ...
      <div className="unified-tech-list">
        ...
        <div className="unified-tech-item">
          ...
          <div className="unified-tech-item-content">
            ...
            <p className="unified-tech-item-desc">
              Полный цикл тестирования занимает от 7 до 24 часов, что критически важно для оперативного исследования инфекций (tNGS), онкопанелей и проведения комплексных генетических исследований.
            </p>
          </div>
        </div>
